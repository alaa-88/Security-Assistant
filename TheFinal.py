...
def Make_Folder():
    ...
    parent_dir = "C:\\Users\\youss\\OneDrive\\Desktop\\Ai_Faculty\\Security Robot\\registered"
    path_of_newdir = os.path.join(parent_dir, name_of_folder)
    the_final_path = os.mkdir(path_of_newdir)
    the_final_dir = "C:\\Users\\youss\\OneDrive\\Desktop\\Ai_Faculty\\Security Robot\\registered\\{}".format(str(name_of_folder))
